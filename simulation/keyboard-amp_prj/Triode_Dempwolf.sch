...
<Components>
  ...
  <EDD D2 1 350 230 66 -26 0 3 "explicit" 0 "2" 0 "(G/C^g)*ln(1 + exp(C*(V1/u + V2)))^g - (Gg/Cg^x)*ln(1 + exp(Cg*V2))^x - Ig0" 1 "0" 0 "(Gg/Cg^x)*ln(1 + exp(Cg*V2))^x + Ig0" 1 "0" 0>
</Components>
<Wires>
  <120 340 320 340 "" 0 0 0 "">
  <320 260 320 340 "" 0 0 0 "">
